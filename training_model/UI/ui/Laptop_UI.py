...
class Ui_MainWindow(object):
    ...
    def handle_take_photo(self):
        ...
        if model == "CNN Model":
            subprocess.run(["python", "C:/Tin/DACS_App_Mobile_Emotion/App_Mobile_Emotion/training_model/CNN_model/CNN_TakePhoto.py"])
        elif model == "MobileNet Model":
            subprocess.run(["python", "C:/Tin/DACS_App_Mobile_Emotion/App_Mobile_Emotion/training_model/MobileNet_model/MobileNet_Photo.py"])
        elif model == "ResNet Model":
            subprocess.run(["python", "C:/Tin/DACS_App_Mobile_Emotion/App_Mobile_Emotion/training_model/ResNet_Model/ResNet_Photo.py"])

    def handle_webcam(self):
        model = self.cmb_model.currentText()
        if model == "CNN Model":
            subprocess.run(["python", "C:/Tin/DACS_App_Mobile_Emotion/App_Mobile_Emotion/training_model/CNN_model/CNN_Webcam_version2.py"])
        elif model == "MobileNet Model":
            subprocess.run(["python", "C:/Tin/DACS_App_Mobile_Emotion/App_Mobile_Emotion/training_model/MobileNet_model/Mobinet_Webcam.py"])
        elif model == "ResNet Model":
            subprocess.run(["python", "C:/Tin/DACS_App_Mobile_Emotion/App_Mobile_Emotion/training_model/ResNet_Model/ResNet18_webcam.py"])
